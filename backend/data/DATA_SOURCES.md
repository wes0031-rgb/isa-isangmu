...
| 카테고리 | 개수 | 주요 출처 |
|---|---|---|
| Golden Query 평가 시나리오 | 1 | MoveWise 팀 |
...
| 퇴거 타임라인 체크리스트 | 1 | MoveWise 팀 편집본 |
| 품질 평가 결과 | 1 | MoveWise 팀 (evaluate_checklist.py 실행) |
...
- **카테고리**: 품질 평가 결과
- **담당 기관**: MoveWise 팀 (evaluate_checklist.py 실행)
- **출처 URL**: N/A
- **라이선스**: 프로젝트 소유
- **갱신 주기**: 자동 (평가 재실행 시)
