...
Output: backend/data/indexes/easylaw_chunks.jsonl         (JSONL, 1 chunk/line)
        backend/data/indexes/easylaw_summary.json         (통계)
...
def main() -> None:
    ...
    out_jsonl = OUT_DIR / "easylaw_chunks.jsonl"
    ...
    (OUT_DIR / "easylaw_summary.json").write_text(
