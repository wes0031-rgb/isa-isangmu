...
LAWS: list[tuple[str, int, str]] = [
    ("주택임대차보호법", 257960, "임대차 대항력·확정일자·우선변제권"),
    ("주택임대차보호법시행령", 257961, "임대차 시행 기준"),
    ("주민등록법", 261923, "전입신고 의무·과태료"),
    ("주민등록법시행령", 261924, "신고 기한 상세"),
    ("동물보호법", 261045, "반려동물 주소변경 30일"),
    ("부동산등기법", 256188, "갑구·을구 구조"),
    ("민법", 259725, "임대차 조항(제618조~)"),
    ("공동주택관리법", 260521, "관리비·장기수선충당금"),
]
