...
const styles = StyleSheet.create({
  ...
  userName: { ...typography.display, fontSize: 30, marginTop: spacing.xs },
  ...
  heroLabel: { color: '#B8D4EC', fontSize: 13, fontWeight: '600' },
  heroRegion: { color: '#B8D4EC', fontSize: 12 },
  heroDay: {
    color: '#fff',
    fontSize: 48,
    fontWeight: '800',
  ...
  heroDate: { color: '#B8D4EC', fontSize: 13, marginBottom: spacing.md },
  ...
  progressLabel: { color: '#B8D4EC', fontSize: 11 },
  progressValue: { color: '#fff', fontSize: 11, fontWeight: '700' },
  progressBar: {
    height: 6,
  ...
  emptyHeroSub: { ...typography.caption, marginTop: spacing.xs },
  ...
  statusText: { ...typography.body, fontSize: 12, flex: 1 },
  statusVersion: { ...typography.caption, fontSize: 11, color: colors.textMute },
  statusError: { ...typography.body, fontSize: 12, color: colors.danger, flex: 1 },
  ...
  deadlineDayText: { color: '#fff', fontSize: 12, fontWeight: '800' },
  deadlineTitle: { ...typography.subtitle, fontSize: 14 },
  deadlineDate: { ...typography.caption, fontSize: 11 },

  // CTAs
  ctaGroup: { gap: spacing.md, marginBottom: spacing.md },
  bigCta: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: colors.cardBg,
  ...
  ctaTitle: { ...typography.subtitle, fontSize: 16 },
  ctaDesc: { ...typography.caption, marginTop: 2 },
  ...
  statUnit: { ...typography.caption, fontSize: 10 },
